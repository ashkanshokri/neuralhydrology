...
def _main():
    ...
    if args["mode"] == "train":
        ...
        finetune(config_file=Path(args["config_file"]), gpu=args["gpu"], data_dir=args["data_dir"])
...
def start_run(config_file: Path, gpu: int = None, data_dir: str = None):
...
def continue_run(run_dir: Path, config_file: Path = None, gpu: int = None, data_dir: str = None):
    ...
    if config_file is not None:
        base_config.update_config({'data_dir': data_dir})
...
def finetune(config_file: Path = None, gpu: int = None, data_dir: str = None):
...
def eval_run(run_dir: Path, period: str, epoch: int = None, gpu: int = None, data_dir: str = None):
